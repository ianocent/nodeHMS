const fs = require('fs');
for (const l of fs.readFileSync('C:/Users/uzuma/Documents/hms-anyaman/backend-node/.env', 'utf8').split(/\r?\n/)) {
...
(async () => {
  try {
    ...
    console.log('first 200 chars:', JSON.stringify(r.data).slice(0, 200));
  } catch (e) {
